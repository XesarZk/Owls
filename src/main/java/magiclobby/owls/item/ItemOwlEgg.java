package magiclobby.owls.item;

import magiclobby.owls.Owls;
import magiclobby.owls.RegistryHandler;
...
public class ItemOwlEgg extends Item {
  ...
  public static ItemOwlEgg create() {
    ...
    EntityRegistry.registerModEntity(new ResourceLocation(Owls.MODID,"EntityOwlEgg"),
        EntityOwlEgg.class, "EntityOwlEgg", Config.entityOwlEggId, Owls.instance, 64, 10, true);
